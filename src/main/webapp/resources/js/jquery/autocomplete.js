...
(function($) {
	...
	$.Autocompleter = function(input, options) {
		...
		// older versions of opera don't trigger keydown multiple times while
	...
	$.Autocompleter.Select = function(options, input, select, config) {
		...
		function init() {
			...
			element = $("<div/>").hide().addClass(options.resultsClass).css(
					...
					function(event) {
						// Browsers except FF do not fire mouseup event on
						// scrollbars, resulting in mouseDownOnSelect remaining
						// true, and results list not always hiding.
						if ($(this).is(":visible")) {
							input.focus();
						}
